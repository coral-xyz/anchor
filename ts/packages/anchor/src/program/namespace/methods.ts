...
export type MethodsNamespace<IDL extends Idl = Idl,
    I extends AllInstructions<IDL> = AllInstructions<IDL>> = MakeMethodsNamespace<IDL, I>;
...
export class MethodsBuilder<IDL extends Idl, I extends AllInstructions<IDL>> {
    ...
    public async pubkeys(): Promise<Partial<InstructionAccountAddresses<IDL, I>>> {
