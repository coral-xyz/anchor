...
/// }
/// ```
pub struct Context<'a, 'b, 'c, 'info, B, T> {
...
impl<'a, 'b, 'c, 'info, B, T: Accounts<'info, B>> Context<'a, 'b, 'c, 'info, B, T> {
    pub fn new(
        program_id: &'a Pubkey,
        accounts: &'b mut T,
...
#[doc(hidden)]
#[deprecated]
pub struct CpiStateContext<'a, 'b, 'c, 'info, B, T: Accounts<'info, B>> {
    state: AccountInfo<'info>,
    cpi_ctx: CpiContext<'a, 'b, 'c, 'info, T>,
    _bumps: PhantomData<B>,
}

#[allow(deprecated)]
impl<'a, 'b, 'c, 'info, B, T: Accounts<'info, B>> CpiStateContext<'a, 'b, 'c, 'info, B, T> {
...
#[allow(deprecated)]
impl<'a, 'b, 'c, 'info, B, T: Accounts<'info, B>> ToAccountMetas
    for CpiStateContext<'a, 'b, 'c, 'info, B, T>
{
    fn to_account_metas(&self, is_signer: Option<bool>) -> Vec<AccountMeta> {
...
#[allow(deprecated)]
impl<'a, 'b, 'c, 'info, B, T: Accounts<'info, B>> ToAccountInfos<'info>
    for CpiStateContext<'a, 'b, 'c, 'info, B, T>
{
    fn to_account_infos(&self) -> Vec<AccountInfo<'info>> {
