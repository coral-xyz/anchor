...
/// # Example
/// ```ignore
/// pub fn set_data(ctx: Context<SetData>, age: u64, other_data: u32) -> AnchorResult<()> {
...
/// pub mod callee {
///     use super::*;
///     pub fn init(ctx: Context<Init>) -> AnchorResult<()> {
...
/// pub mod caller {
///     use super::*;
///     pub fn do_cpi(ctx: Context<DoCpi>, data: u64) -> AnchorResult<()> {
...
///     }
///
///     pub fn do_cpi_with_pda_authority(ctx: Context<DoCpiWithPDAAuthority>, bump: u8, data: u64) -> AnchorResult<()> {
