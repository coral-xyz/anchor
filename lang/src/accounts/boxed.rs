...
use crate::{Accounts, AccountsClose, AccountsExit, Result, ToAccountInfos, ToAccountMetas, TryAccountInfos};
...
impl<'info, T: ToAccountInfos<'info>> TryAccountInfos<'info> for Box<T> {
