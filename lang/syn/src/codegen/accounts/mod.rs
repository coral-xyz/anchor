...
pub fn generate(accs: &AccountsStruct) -> proc_macro2::TokenStream {
    ...
    let impl_to_optional_account_infos = if accs.has_optional() {
        to_optional_account_infos::generate(accs)
    } else {
        quote! {}
    };
    ...
    quote! {
        ...
        #impl_to_optional_account_infos
