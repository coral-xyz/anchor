...
pub fn generate(program: &Program) -> proc_macro2::TokenStream {
    ...
    let non_inlined_idl: proc_macro2::TokenStream = {
        quote! {
            ...
            #[cfg(feature = "no-idl")]
            pub fn __idl_dispatch(program_id: &Pubkey, accounts: &[AccountInfo], idl_ix_data: &[u8]) -> AnchorResult<()> {
                Err(anchor_lang::anchor_attribute_error::error!(anchor_lang::error::ErrorCode::IdlInstructionStub))
            }
            ...
            pub fn __idl_create_account(
                ...
                if program_id != accounts.program.key {
                    return Err(anchor_lang::anchor_attribute_error::error!(anchor_lang::error::ErrorCode::IdlInstructionInvalidProgram));
                }
                        ...
                        if state.is_zero_copy {
                            quote! {
                                ...
                                pub fn #private_ix_method_name(
                                    ...
                                    if remaining_accounts.is_empty() {
                                        return Err(anchor_lang::anchor_attribute_error::error!(anchor_lang::error::ErrorCode::AccountNotEnoughKeys));
                                    }
                            ...
                            quote! {
                                ...
                                pub fn #private_ix_method_name(
                                    ...
                                    // Deserialize instruction.
                                    let ix = instruction::state::#ix_name::deserialize(&mut &ix_data[..])
                                        .map_err(|_| anchor_lang::anchor_attribute_error::error!(
