...
To make writing errors even easier, anchor also provides the [`bail!`](https://docs.rs/anchor-lang/latest/anchor_lang/prelude/macro.bail.html and the [`require!`](https://docs.rs/anchor-lang/latest/anchor_lang/prelude/macro.require.html macros.
