...
avm completions bash > $HOME/.local/share/bash-completion/completions/anchor
...
avm completions fish > $HOME/.config/fish/completions/anchor.fish
...
```bash
avm completions zsh | sudo tee /usr/local/share/zsh/site-functions/_anchor
