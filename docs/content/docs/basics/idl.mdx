...
codebase
[here](https://github.com/coral-xyz/anchor/blob/v0.31.0/lang/syn/src/codegen/program/common.rs#L5-L19), 
...
which is used
[here](https://github.com/coral-xyz/anchor/blob/v0.31.0/lang/syn/src/codegen/program/instruction.rs#L33).
...
You can find the implementation of the discriminator generation in the Anchor
codebase
[here](https://github.com/coral-xyz/anchor/blob/v0.31.0/lang/attribute/account/src/lib.rs#L101-L117).
