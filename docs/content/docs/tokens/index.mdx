...
The [`anchor-spl`](https://github.com/coral-xyz/anchor/tree/v0.31.0/spl) crate
...
| Module                                                                                                    | Description                                                                              |
| --------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| [`token`](https://github.com/coral-xyz/anchor/blob/v0.31.0/spl/src/token.rs)                              | Token Program (legacy) instructions and account types                                    |
| [`token_2022`](https://github.com/coral-xyz/anchor/blob/v0.31.0/spl/src/token_2022.rs)                    | Token 2022 base instructions (instructions matching the Token Program functionality)     |
| [`token_2022_extensions`](https://github.com/coral-xyz/anchor/tree/v0.31.0/spl/src/token_2022_extensions) | Token 2022 extensions instructions                                                       |
| [`token_interface`](https://github.com/coral-xyz/anchor/blob/v0.31.0/spl/src/token_interface.rs)          | Implementation of account types that work with both Token Program and Token 2022 Program |
| [`associated_token`](https://github.com/coral-xyz/anchor/blob/v0.31.0/spl/src/associated_token.rs)        | Associated token account instruction                                                     |
