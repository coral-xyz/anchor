...
The
[`Result<T>`](https://github.com/coral-xyz/anchor/blob/v0.31.0/lang/src/lib.rs#L77)
...
[`Error`](https://github.com/coral-xyz/anchor/blob/v0.31.0/lang/src/error.rs#L277-L281)
type defined as:
...
1. [`ProgramErrorWithOrigin`](https://github.com/coral-xyz/anchor/blob/v0.31.0/lang/src/error.rs#L389-L394):
...
2. [`AnchorError`](https://github.com/coral-xyz/anchor/blob/v0.31.0/lang/src/error.rs#L490-L497):
...
1. Internal Anchor Errors - These are built-in errors included with the Anchor
   ...
   [`ErrorCode`](https://github.com/coral-xyz/anchor/blob/v0.31.0/lang/src/error.rs#L10-L275)
   enum.
...
[`err!`](https://github.com/coral-xyz/anchor/blob/v0.31.0/lang/src/lib.rs#L735-L743)
...
[here](https://github.com/coral-xyz/anchor/blob/v0.31.0/lang/attribute/error/src/lib.rs#L84-L116).
...
The
[`require!`](https://github.com/coral-xyz/anchor/blob/v0.31.0/lang/src/lib.rs#L525-L537)
...
[here](https://github.com/coral-xyz/anchor/blob/v0.31.0/lang/src/lib.rs).
...
[error response](https://github.com/coral-xyz/anchor/blob/v0.31.0/ts/packages/anchor/src/error.ts#L51-L71)
