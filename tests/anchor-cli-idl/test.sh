...
# Generate 10,240 bytes of random data (base64 encoded), surround it with quotes, and store it in a variable
RANDOM_DATA=$(openssl rand -base64 $((10*1240)) | sed 's/.*/"&",/')
  ...
  "instructions": [
    {
      "name": "initialize",
      "docs" : [
        '$RANDOM_DATA' "trailing comma begone"
      ],
      "accounts": [],
      "args": []
    }
